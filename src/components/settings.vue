<template >
  <v-row justify="center" class="hideY">
    <v-dialog v-model="show" persistent max-width="600px" fullscreen>
      ...
      <v-card class="black500 showY" width="100%" max-width="100%">
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="blue darken-1" text @click="this.closeDialog">
            Close
          </v-btn>
  ...
  methods: {
    ...
    savePlugin: function () {
      ...
      this.$emit("addplugin", {
        ...
        function: "function(args = null){this.drawer = !this.drawer;}",
      });
    },
  },
  watch: {
