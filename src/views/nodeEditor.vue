<template>
  <div class="hideX hideY">
    <cabecalho></cabecalho>
    <div id="rete" class="black600"></div>

    <v-card
      v-draggable
      style="position: fixed; top: 10px; left: 10px; max-width: 200px"
      class="black500 black100t"
    >
      <v-card-title primary-title class="toolBox"> ToolBOx </v-card-title>
            ...
            >
              <v-expansion-panel-header class="black100t ma-0 pa-0">
                <v-row class="pa-0 ma-0">
                  <v-icon class="yellow100t mr-2 ml-2" v-text="item.icon">
                  </v-icon>
                  {{ item.title }}
                </v-row>
              ...
              <v-expansion-panel-content>
                <v-list dense class="ma-0 pa-0">
                  ...
                  >
                    <v-list-item
                      v-for="tool in item.options"
                      :key="tool.title"
                      @click="addNode(tool.title)"
                    >
                      <v-list-item-icon>
